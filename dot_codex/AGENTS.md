...
- Finalize process: Remove ALL meta-comments about your changes, such as "// Added XXX" or "# Removed XXX", "// XXX has been moved to..." from the code you newly wrote or modified before applying the changes. Do NOT remove or alter comments that already existed in the codebase.
